                            ...
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full  {{ ($user->status==1) ?'text-green-800':'text-red-600 hover:text-red-900' }}">
                                        ...
                                        @if($user->status==1) 
                                            ...
                                            @else
                                            <a href="{{ route('users.activate', $user->id) }}" class="text-green-800 bg-green-100">Activate</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
